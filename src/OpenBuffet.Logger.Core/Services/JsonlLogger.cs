...
using OpenBuffet.Logger.Core.Entities;
...
namespace OpenBuffet.Logger.Core.Services {
    /// <summary>
    /// this class a jsonl logger service
    /// </summary>
    public sealed class JsonlLogger : ILoggerService {
        /// <summary>
        /// this field keeps the file type extention
        /// </summary>
        private const string FILE_TYPE = ".jsonl";
        /// <summary>
        ...
        /// <summary>
        /// this field keeps the jsonl configurator object
        /// </summary>
        private readonly JsonlLoggerConfigurator _jsonlConfigurator;
        /// <summary>
        ...
        /// <summary>
        /// this constructor set the jsonl configurator
        /// log file directory(add the "Logs" folder togiven path givenPath/Logs)
        /// and set the string builder
        /// </summary>
        /// <param name="configuration">jsonl configurator</param>
        public JsonlLogger(JsonlLoggerConfigurator configuration) {
            _jsonlConfigurator = configuration;
            _logFileDirectory = Path.Combine(_jsonlConfigurator.Path, "Logs");
        ...
        public bool TryLogging(LogType logType, string content, out Exception exception) {
            ...
            try {
                ...
                JsonLogObject logObject = new JsonLogObject();
                logObject.LogType = logType;
                logObject.LogDate = DateTime.Now;
                logObject.LogContent = content;
                string preparedLog = JsonSerializer.Serialize(logObject) + "\n";
                if (!Directory.Exists(_logFileDirectory)) {
